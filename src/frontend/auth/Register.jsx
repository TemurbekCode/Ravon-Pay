...
export default function Register() {
  ...
  // 'type' (tur tanlash) -> 'form' (ma'lumot) -> 'card' (karta ulash, ixtiyoriy)
  const [step, setStep] = useState('type');
  const [accountType, setAccountType] = useState(ACCOUNT_TYPES.PERSONAL);
  const [form, setForm] = useState({ companyName: '', fullName: '', phone: '', email: '', password: '', terms: false });
  ...
  return (
    <AuthShell>
      {step === 'card' ? (
        // ===== BOSQICH 3: KARTA ULASH (ixtiyoriy) =====
        <>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="field">
              ...
              <div className="input-wrap">
                ...
                <input type="email" placeholder={t('ph.email')} value={form.email}
            ...
            <div className="field">
              ...
              <div className="input-wrap">
                ...
                <input type={showPass ? 'text' : 'password'} placeholder={t('ph.createpass')} value={form.password}
